  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap -m-4 p-4">
    {
      products.map((product)=>{
        ...
        const {id, title , rating, description,price,category,image } =product;
        return(
          <Link to={`/products/${id}`} className="lg:w-1/4 md:w-1/2 p-4 w-full shadow-sm border border-opacity-50 mb-4 cursor-pointer">
